// Assuming 'toolbars.js' is in the '/common' directory under '/components'
...
class TabManager {
    ...
    setupTabs() {
        ...
        const userRole = this.store.getUserRole(); // Retrieve the user role from the store
        const rolesToTabs = {
            "365admin": [
        ...
        this.tabs = rolesToTabs[userRole] || [];
        this.initTabs();
    }
    ...
    initTabs() {
        ...
        this.tabs.forEach(tab => {
            ...
            const toolbar = tab.toolbar(); // Append the toolbar
